...
return [
    ...
    'button_position' => "B<'row'<'col-lg-6 datatable-pull-right'l><'col-lg-6 datatable-pull-left'f>>tr<'row'<'col-lg-6 datatable-pull-left'i><'col-lg-4 datatable-pull-right'p>>",
    ...
    'event' => [
        ...
        'onLoad'            => function() {
            ...
            return "<script>
//                 $('.dataTables_length').find('select').attr('data-style','btn-info').attr('data-width','80px').attr('data-class','btn-rounded').select2();        
                  </script>";
        },
        ...
        'modalOpen'         => function() {
            ...
            return "<script>
                    _selectPicker();
                     $('select.datatable-autocomplete[data-float]').each(function(){
                        $(this).parent().parent().css('float',$(this).data('float'));
                    });
                </script>";
        },
